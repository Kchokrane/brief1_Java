...
public class Etudient extends personne {
	...
	private int id;
 public Etudient() {}
	public Etudient(String Nom, String Prenom, String Email, String Filiere) {
	...
	//Ajouter etudient
	//composition
	public static void Ajouteretudient(Etudient etudient, ArrayList<Etudient> etud ) {
		etud.add(etudient);
		System.out.println("Ajouter etudient avec succes  :" + etud);
	}
	//supprimer etudient
	public void supprimerEtudient(ArrayList<Etudient> listEtudient ,int id) {
	...
	//Modifier etudient
	public void modifierEtudient(ArrayList<Etudient> ListEtudient, int id, String Nom,String prenom,String email,String filiere) {
		for(int j=0;j<ListEtudient.size();j++) {
			if(id==ListEtudient.get(j).getId()) {
